        ...
        <div>
             <footer className="flex flex-col bg-slate-50 items-center justify-around w-full py-16 text-sm text-gray-800/70">
                ...
                <div className="flex items-center gap-4 mt-8 text-indigo-500">
                    <a href="https://www.facebook.com/plabon48/" className="hover:-translate-y-0.5 transition-all duration-300" target='_blank'>
                ...
                <p className="mt-8 text-center"> © 2026 Abid Hasan Plabon. All rights reservered.</p>
            </footer>
        </div>
    );
};
